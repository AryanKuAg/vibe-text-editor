...
// import { handleCommandNavigation } from './editor/extensions';
...
// // Import the prosemirror styles
// import '@/styles/prosemirror.css';

// interface NovelEditorWrapperProps {
//   content: string;
//   onChange: (content: string) => void;
//   placeholder?: string; // Not used directly, but kept for API compatibility
// }

// export default function NovelEditorWrapper({
//   content,
//   onChange,
//   placeholder = 'Start writing...' // Placeholder is handled by the extensions
...
//   // Create a debounced callback for updates
